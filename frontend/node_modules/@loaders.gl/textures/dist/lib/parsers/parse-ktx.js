...
import { mapVkFormatToTextureFormat } from "../utils/ktx-format-helper.js";
const KTX2_ID = [
    // '´', 'K', 'T', 'X', '2', '0', 'ª', '\r', '\n', '\x1A', '\n'
...
export function parseKTX(arrayBuffer) {
    ...
    if (textureFormat === undefined) {
        ...
        log.warn(`KTX2 container vkFormat ${ktx.vkFormat} does not map to a known texture format; returning texture levels without format metadata.`)();
    }
