...
export declare const CesiumIonLoader: {
    ...
    readonly parse: (data: ArrayBuffer, options?: StrictLoaderOptions | undefined, context?: import("@loaders.gl/loader-utils").LoaderContext | undefined) => Promise<import("./types").Tiles3DTilesetJSONPostprocessed | import("./types").Tiles3DTileContent>;
    readonly options: {
        readonly 'cesium-ion': {
