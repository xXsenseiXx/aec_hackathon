 ...
 */
export declare const parseZipCDFileHeader: (headerOffset: bigint, file: ReadableFile) => Promise<ZipCDFileHeader | null>;
/**
 * Create iterator over files of zip archive
 * @param fileProvider - readable file that provides random access to the file
 */
export declare function makeZipCDHeaderIterator(fileProvider: ReadableFile): AsyncIterable<ZipCDFileHeader>;
