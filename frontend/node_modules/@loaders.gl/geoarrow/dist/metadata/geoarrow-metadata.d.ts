import { Metadata, SchemaWithMetadata } from "./metadata-utils.js";
 ...
 */
export declare function getGeometryColumnsFromSchema(schema: SchemaWithMetadata): Record<string, GeoArrowMetadata>;
/**
 ...
 */
export declare function getGeometryMetadataForField(fieldMetadata: Metadata): GeoArrowMetadata | null;
