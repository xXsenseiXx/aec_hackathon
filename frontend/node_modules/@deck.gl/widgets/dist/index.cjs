...
var ZoomWidget = class extends import_core.Widget {
  ...
  handleZoomIn() {
    var _a;
    const viewIds = this.viewId ? [this.viewId] : ((_a = this.deck) == null ? void 0 : _a.getViews().map((v) => v.id)) ?? [];
...
var ThemeWidget = class extends import_core20.Widget {
  ...
  setProps(props) {
    ...
    switch (currentMode) {
      case "light":
        if (props.lightModeTheme && !(0, import_core19._deepEqual)(props.lightModeTheme, lightModeTheme, 1)) {
          this._applyTheme("light");
        }
        break;
      case "dark":
        if (props.darkModeTheme && !(0, import_core19._deepEqual)(props.darkModeTheme, darkModeTheme, 1)) {
          this._applyTheme("dark");
        }
        break;
      default:
        import_core19.log.warn(`Invalid theme mode ${currentMode}`)();
    }
  }
  onRenderHTML(rootElement) {
