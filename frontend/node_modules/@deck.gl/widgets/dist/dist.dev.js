...
var __exports__ = (() => {
  ...
  var ZoomWidget = class extends import_core2.Widget {
    ...
    handleZoomIn() {
      const viewIds = this.viewId ? [this.viewId] : this.deck?.getViews().map((v3) => v3.id) ?? [];
    ...
    onRenderHTML(rootElement) {
      ...
      const ui = /* @__PURE__ */ u2("div", { children: [
        marker && /* @__PURE__ */ u2(
          "div",
          {
            style: { position: "absolute", left: x2, top: y3, pointerEvents: "all", cursor: "pointer" },
            children: /* @__PURE__ */ u2(UserContent, { ...marker, onClick: () => this._setIsOpen(true) })
          }
        ),
  ...
  var ThemeWidget = class extends import_core22.Widget {
    ...
    setProps(props) {
      ...
      switch (currentMode) {
        case "light":
          if (props.lightModeTheme && !(0, import_core21._deepEqual)(props.lightModeTheme, lightModeTheme, 1)) {
            this._applyTheme("light");
          }
          break;
        case "dark":
          if (props.darkModeTheme && !(0, import_core21._deepEqual)(props.darkModeTheme, darkModeTheme, 1)) {
            this._applyTheme("dark");
          }
          break;
        default:
          import_core21.log.warn(`Invalid theme mode ${currentMode}`)();
      }
    }
    onRenderHTML(rootElement) {
