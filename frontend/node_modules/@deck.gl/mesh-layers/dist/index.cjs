...
var SimpleMeshLayer = class extends import_core2.Layer {
  getShaders() {
    return super.getShaders({
      ...
      modules: [import_core2.project32, import_core2.phongMaterial, import_core2.picking, simpleMeshUniforms]
    });
  }
  getBounds() {
    var _a;
...
var uniformBlock2 = `layout(std140) uniform scenegraphUniforms {
  float sizeScale;
  float sizeMinPixels;
  float sizeMaxPixels;
...
var ScenegraphLayer = class extends import_core4.Layer {
  getShaders() {
    ...
    if (this.props._lighting === "pbr") {
      pbr = import_shadertools.pbrMaterial;
