 ...
 */
export declare function getTileIndices({ viewport, maxZoom, minZoom, zRange, extent, tileSize, modelMatrix, modelMatrixInverse, zoomOffset, visibleMinZoom, visibleMaxZoom }: {
    viewport: Viewport;
    maxZoom?: number;
    minZoom?: number;
    zRange: ZRange | null;
