...
var import_core14, import_constants15, WEBGLTexture;
...
function readUniformBlocks(gl, program) {
  ...
  for (let blockIndex = 0; blockIndex < blockCount; blockIndex++) {
    ...
    if (uniformInstancePrefixes.size === 1 && !uniformInstancePrefixes.has(blockInfo.name) && !uniformInstancePrefixes.has(blockAlias)) {
      ...
      import_core16.log.warn(`Uniform block "${blockInfo.name}" uses GLSL instance "${instanceName}". luma.gl binds uniform buffers by block name ("${blockInfo.name}") and alias ("${blockAlias}"). Prefer matching the instance name to one of those to avoid confusing silent mismatches.`)();
    }
...
function parseUniformName(name) {
  ...
  const uniformName = (0, import_core16.assertDefined)(matches == null ? void 0 : matches[1], `Failed to parse GLSL uniform name ${name}`);
  return {
    name: uniformName,
...
var import_core16, import_constants20;
...
var import_constants21, import_core17, LOG_PROGRAM_PERF_PRIORITY, WEBGLSharedRenderPipeline;
...
var import_core18, import_constants22, WEBGLCommandBuffer;
...
var import_core19, import_constants23, COLOR_CHANNELS, WEBGLRenderPass;
...
var import_core21, import_constants24, import_env2, WEBGLVertexArray;
...
var import_core22, import_constants25, WEBGLTransformFeedback;
...
var import_core23, import_constants26, WEBGLQuerySet;
...
var import_core25, import_constants28;
var init_webgl_texture_utils = __esm({
  "dist/adapter/helpers/webgl-texture-utils.js"() {
    "use strict";
    import_core25 = require("@luma.gl/core");
    import_constants28 = require("@luma.gl/webgl/constants");
    init_webgl_shadertypes();
    init_format_utils();
    init_shader_formats();
  }
    ...
    WebGLAdapter = class extends import_core27.Adapter {
      ...
      async create(props = {}) {
        ...
        try {
          ...
          import_core27.log.info(LOG_LEVEL2, `%cWebGL call tracing: luma.log.set('debug-webgl') `, "color: white; background: blue; padding: 2px 6px; border-radius: 3px;")();
        }
      }
    };
